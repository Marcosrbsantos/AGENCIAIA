...
.sub-text {{ font-size: 26px; font-weight: 800; color: #D68311; position: absolute; top: 580px; left: 100px; z-index: 20; }}
.quotes-container {{ position: absolute; top: 760px; left: 100px; z-index: 20; }}
...
.quotes {{ margin-top: 30px; font-size: 30px; color: #FFE3B3; text-align: left; line-height: 1.6; font-weight: 600; padding-left: 20px; }}
.quotes .break {{ margin-top: 15px; display: block; }}
...
<div class="card">
    ...
    <div class="quotes">
        <span class="break">"você tem uma nova notificação"</span>
        <span class="break">"você precisa responder agora"</span>
        <span class="break">"veja o que estão fazendo"</span>
    </div>
    <div class="buttons-row">
        <span>você entra</span>
        <span class="btn-ativo">consome o dia</span>
        <span style="opacity: 0.5;">fica vazio</span>
    </div>
</div>
...
def generate_html_slide3():
    img_warrior = "file:///" + os.path.abspath("C:/Users/Admin/.gemini/antigravity/brain/bb885d9d-17c4-480d-8b96-bc832cb3e051/new_warrior_transparent.png").replace("\\", "/")
    return f"""<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
.statue {{ position: absolute; right: -200px; bottom: -80px; width: 850px; z-index: 10; filter: drop-shadow(-20px 20px 30px rgba(0,0,0,0.7)); }}
...
async def generate_all_images():
    ...
    os.makedirs("c:/Users/Admin/Desktop/Agente/outputs/carrossel_creata_v6", exist_ok=True)
    ...
    async with async_playwright() as p:
        ...
        await page.screenshot(path="c:/Users/Admin/Desktop/Agente/outputs/carrossel_creata_v6/slide_01.png", type="png")
        
        await page.goto("file:///" + os.path.abspath("c:/Users/Admin/Desktop/Agente/execution/temp_slide2.html").replace("\\", "/"))
        await page.wait_for_timeout(2000)
        await page.screenshot(path="c:/Users/Admin/Desktop/Agente/outputs/carrossel_creata_v6/slide_02.png", type="png")
        
        await page.goto("file:///" + os.path.abspath("c:/Users/Admin/Desktop/Agente/execution/temp_slide3.html").replace("\\", "/"))
        await page.wait_for_timeout(2000)
        await page.screenshot(path="c:/Users/Admin/Desktop/Agente/outputs/carrossel_creata_v6/slide_03.png", type="png")
        
        await page.goto("file:///" + os.path.abspath("c:/Users/Admin/Desktop/Agente/execution/temp_slide4.html").replace("\\", "/"))
        await page.wait_for_timeout(2000)
        await page.screenshot(path="c:/Users/Admin/Desktop/Agente/outputs/carrossel_creata_v6/slide_04.png", type="png")
        
        await browser.close()
        
    print("✅ Carrossel Creata v6 gerado com sucesso!")
